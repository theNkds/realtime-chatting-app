...
const Sidebar = () => {
    ...
    return (
        <aside className="h-full w-20 lg:w-70 border-r border-base-300 flex flex-col transition-all duration-200">
            ...
            <div className="overflow-y-auto w-full py-3">
                {filteredUsers.map((user) => (
                    <button
                        ...
                        className={`
                            w-full p-3 flex items-center gap-3 hover-base-300 transition
                            ${selectedUser?._id === user._id ? "bg-base-300 ring-0 ring-base-300" : ""}    
                        `}
                    >
